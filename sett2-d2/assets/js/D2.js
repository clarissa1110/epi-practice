...
/*if (numero1 === 8 || numero2 === 8 || numero1 + numero2 === 8 || numero1 - numero2 === 8 || numero2 - numero1 === 8) -> true ; else -> false */
...
let result = (discount / 100) * totalShoppingCart;
...
const ordina = [numero1, numero2, numero3];
ordina.reverse();
console.log(ordina); */
